...
* isAuthenticated  - функція для перевірки, якщо користувач зайшов в свій акаунт, то відображається на головній сторінці його фото профіля і невелика інформація про нього. Якщо користувач не зайшов, то відображається в рамці текст «Спочатку зайдіть в акаунт!»
