...
`App.js` - основний файл проекту, в якому ми створюємо наш сайт<br/>
`App.test.js` -це набір допоміжних функцій, що дозволяє тестувати React-компоненти не покладаючись на їх внутрішню реалізацію<br/>
